...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct AABBD : IEquatable<AABBD>, IFormattable
    {
        ...
        public AABBD(Double3 min, Double3 max)
        {
            Min = new Double3(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AABBD FromCenterAndSize(Double3 center, Double3 size)
        {
            Double3 halfSize = size / 2.0;
            return new AABBD(center - halfSize, center + halfSize);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Contains(AABBD other)
        {
        ...
        {
            return IntersectionD.AABBAABBOverlap(Min, Max, other.Min, other.Max);
        }
        ...
        {
            return IntersectionD.SphereAABBOverlap(sphere.Center, sphere.Radius, Min, Max);
        }
        ...
        public Double3 ClosestPointTo(Double3 point)
        {
            ...
            IntersectionD.ClosestPointOnAABBToPoint(point, Min, Max, out closestPoint);
            return closestPoint;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Encapsulate(AABBD other)
        {
            Min = new Double3(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AABBD Encapsulating(Double3 point)
        {
            var result = this;
        ...
        /// <returns>The encapsulating AABB.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AABBD Encapsulating(AABBD other)
        {
            var result = this;
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBD Expanded(double amount)
       {
           var result = this;
       ...
       /// <returns>The expanded AABB.</returns>
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBD Expanded(Double3 expansion)
       {
           var result = this;
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBD Transform(Double4x4 matrix)
       {
           ...
           return new AABBD(newMin, newMax);
       }
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBD ClippedBy(AABBD other)
       {
       ...
       public static AABBD FromPoints(Double3[] points)
       {
       ...
       public static AABBD FromAABBs(AABBD[] aabbs)
       {
           if (aabbs == null || aabbs.Length == 0)
               return new AABBD(Double3.Zero, Double3.Zero);

           AABBD result = aabbs[0];
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public static AABBD FromSphere(SphereD sphere)
       {
           Double3 radiusVector = new Double3(sphere.Radius, sphere.Radius, sphere.Radius);
           return new AABBD(sphere.Center - radiusVector, sphere.Center + radiusVector);
       }

       // --- IEquatable & IFormattable Implementation ---
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public bool Equals(AABBD other) => Min.Equals(other.Min) && Max.Equals(other.Max);

       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public override bool Equals(object? obj) => obj is AABBD other && Equals(other);
       ...
       public static bool operator ==(AABBD left, AABBD right) => left.Equals(right);
       public static bool operator !=(AABBD left, AABBD right) => !left.Equals(right);
   }
}
