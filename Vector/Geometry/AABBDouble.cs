...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct AABBDouble : IEquatable<AABBDouble>, IFormattable
    {
        ...
        public AABBDouble(Double3 min, Double3 max)
        {
            Min = new Double3(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AABBDouble(double minX, double minY, double minZ, double maxX, double maxY, double maxZ)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AABBDouble FromCenterAndSize(Double3 center, Double3 size)
        {
            Double3 halfSize = size / 2.0;
            return new AABBDouble(center - halfSize, center + halfSize);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Contains(AABBDouble other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Intersects(AABBDouble other)
        {
            return IntersectionDouble.AABBAABBOverlap(Min, Max, other.Min, other.Max);
        }
        ...
        {
            return IntersectionDouble.SphereAABBOverlap(sphere.Center, sphere.Radius, Min, Max);
        }
        ...
        public Double3 ClosestPointTo(Double3 point)
        {
            ...
            IntersectionDouble.ClosestPointOnAABBToPoint(point, Min, Max, out closestPoint);
            return closestPoint;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Encapsulate(AABBDouble other)
        {
            Min = new Double3(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AABBDouble Encapsulating(Double3 point)
        {
            var result = this;
        ...
        /// <returns>The encapsulating AABB.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AABBDouble Encapsulating(AABBDouble other)
        {
            var result = this;
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBDouble Expanded(double amount)
       {
           var result = this;
       ...
       /// <returns>The expanded AABB.</returns>
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBDouble Expanded(Double3 expansion)
       {
           var result = this;
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBDouble Transform(Double4x4 matrix)
       {
           // Transform all 8 corners and find the new AABB
           Double3[] corners = GetCorners();
           Double3 newMin = Maths.TransformPoint(corners[0], matrix);
           Double3 newMax = newMin;

           for (int i = 1; i < 8; i++)
           {
               Double3 transformedCorner = Maths.TransformPoint(corners[i], matrix);
               newMin = new Double3(
           ...
           return new AABBDouble(newMin, newMax);
       }
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBDouble ClippedBy(AABBDouble other)
       {
       ...
       public static AABBDouble FromPoints(Double3[] points)
       {
       ...
       public static AABBDouble FromAABBs(AABBDouble[] aabbs)
       {
           if (aabbs == null || aabbs.Length == 0)
               return new AABBDouble(Double3.Zero, Double3.Zero);

           AABBDouble result = aabbs[0];
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public static AABBDouble FromSphere(SphereDouble sphere)
       {
           Double3 radiusVector = new Double3(sphere.Radius, sphere.Radius, sphere.Radius);
           return new AABBDouble(sphere.Center - radiusVector, sphere.Center + radiusVector);
       }

       // --- IEquatable & IFormattable Implementation ---
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public bool Equals(AABBDouble other) => Min.Equals(other.Min) && Max.Equals(other.Max);

       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public override bool Equals(object? obj) => obj is AABBDouble other && Equals(other);
       ...
       {
           return string.Format(formatProvider, "AABBDouble(Min: {0}, Max: {1})", 
               Min.ToString(format, formatProvider), Max.ToString(format, formatProvider));
       }

       public static bool operator ==(AABBDouble left, AABBDouble right) => left.Equals(right);
       public static bool operator !=(AABBDouble left, AABBDouble right) => !left.Equals(right);
   }
}
