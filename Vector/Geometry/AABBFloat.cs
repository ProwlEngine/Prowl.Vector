...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct AABBFloat : IEquatable<AABBFloat>, IFormattable
    {
        ...
        public AABBFloat(Float3 min, Float3 max)
        {
            Min = new Float3(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static AABBFloat FromCenterAndSize(Float3 center, Float3 size)
        {
            Float3 halfSize = size / 2f;
            return new AABBFloat(center - halfSize, center + halfSize);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Contains(AABBFloat other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Intersects(AABBFloat other)
        {
            return IntersectionFloat.AABBAABBOverlap(Min, Max, other.Min, other.Max);
        }
        ...
        {
            return IntersectionFloat.SphereAABBOverlap(sphere.Center, sphere.Radius, Min, Max);
        }
        ...
        {
            Float3 closestPoint;
            IntersectionFloat.ClosestPointOnAABBToPoint(point, Min, Max, out closestPoint);
            return closestPoint;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Encapsulate(AABBFloat other)
        {
            Min = new Float3(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AABBFloat Encapsulating(Float3 point)
        {
            var result = this;
        ...
        /// <returns>The encapsulating AABB.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public AABBFloat Encapsulating(AABBFloat other)
        {
            var result = this;
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBFloat Expanded(float amount)
       {
           var result = this;
       ...
       /// <returns>The expanded AABB.</returns>
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBFloat Expanded(Float3 expansion)
       {
           var result = this;
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBFloat Transform(Float4x4 matrix)
       {
           // Transform all 8 corners and find the new AABB
           Float3[] corners = GetCorners();
           Float3 newMin = Maths.TransformPoint(corners[0], matrix);
           Float3 newMax = newMin;

           for (int i = 1; i < 8; i++)
           {
               Float3 transformedCorner = Maths.TransformPoint(corners[i], matrix);
               newMin = new Float3(
           ...
           return new AABBFloat(newMin, newMax);
       }
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public AABBFloat ClippedBy(AABBFloat other)
       {
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public Float3 SampleVolume(float u, float v, float w)
       {
           return new Float3(
       ...
       public Float3 GetFaceNormal(int faceIndex)
       {
           switch (faceIndex)
           {
               case 0: return new Float3(-1f, 0f, 0f);  // -X face
               case 1: return new Float3(1f, 0f, 0f);   // +X face
               case 2: return new Float3(0f, -1f, 0f);  // -Y face
               case 3: return new Float3(0f, 1f, 0f);   // +Y face
               case 4: return new Float3(0f, 0f, -1f);  // -Z face
               case 5: return new Float3(0f, 0f, 1f);   // +Z face
       ...
       public static AABBFloat FromPoints(Float3[] points)
       {
       ...
       public static AABBFloat FromAABBs(AABBFloat[] aabbs)
       {
           if (aabbs == null || aabbs.Length == 0)
               return new AABBFloat(Float3.Zero, Float3.Zero);

           AABBFloat result = aabbs[0];
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public static AABBFloat FromSphere(SphereFloat sphere)
       {
           Float3 radiusVector = new Float3(sphere.Radius, sphere.Radius, sphere.Radius);
           return new AABBFloat(sphere.Center - radiusVector, sphere.Center + radiusVector);
       }

       // --- IEquatable & IFormattable Implementation ---
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public bool Equals(AABBFloat other) => Min.Equals(other.Min) && Max.Equals(other.Max);

       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public override bool Equals(object? obj) => obj is AABBFloat other && Equals(other);
       ...
       {
           return string.Format(formatProvider, "AABBFloat(Min: {0}, Max: {1})", 
               Min.ToString(format, formatProvider), Max.ToString(format, formatProvider));
       }

       public static bool operator ==(AABBFloat left, AABBFloat right) => left.Equals(right);
       public static bool operator !=(AABBFloat left, AABBFloat right) => !left.Equals(right);
   }
}
