...
namespace Prowl.Vector.Geometry
{
    ...
    public struct Frustrum : IEquatable<Frustrum>, IFormattable
    {
        ...
        public static Frustrum FromMatrix(Float4x4 viewProjectionMatrix)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Frustrum FromMatrices(Float4x4 viewMatrix, Float4x4 projectionMatrix)
        {
        ...
        public Frustrum Transform(Float4x4 matrix)
        {
            var transformedPlanes = new Plane[6];
            
            // Transform each plane by the inverse transpose of the matrix
            Float4x4 invTranspose = Maths.Transpose(matrix.Invert());
        ...
        public static Frustrum FromCamera(Float3 position, Float3 forward, Float3 up, 
                                               float fovY, float aspect, float nearDist, float farDist)
        {
            ...
            // Near and far planes
            Plane near = new Plane(forward, Maths.Dot(forward, nearCenter));
            Plane far = new Plane(-forward, Maths.Dot(-forward, farCenter));
            ...
            Plane p_left = new Plane(leftNormal, Maths.Dot(leftNormal, position));
            Plane p_right = new Plane(rightNormal, Maths.Dot(rightNormal, position));
            Plane p_top = new Plane(topNormal, Maths.Dot(topNormal, position));
            Plane p_bottom = new Plane(bottomNormal, Maths.Dot(bottomNormal, position));
        ...
        public static Frustrum CreateOrthographic(float left, float right, float bottom, 
                                                        float top, float nearDist, float farDist)
        {
            var planes = new Plane[6];
            
            // Near and far planes (assuming Z forward)
            planes[0] = new Plane(new Float3(0f, 0f, 1f), nearDist);
            planes[1] = new Plane(new Float3(0f, 0f, -1f), -farDist);
            
            // Side planes
            planes[2] = new Plane(new Float3(1f, 0f, 0f), -left);    // Left
            planes[3] = new Plane(new Float3(-1f, 0f, 0f), right);   // Right
            planes[4] = new Plane(new Float3(0f, -1f, 0f), top);     // Top
            planes[5] = new Plane(new Float3(0f, 1f, 0f), -bottom);  // Bottom
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Frustrum Expanded(float amount)
        {
            var result = this;
        ...
        {
            if (Planes == null)
                return "Frustrum(null)";
                
            return string.Format(formatProvider, 
                "Frustrum(Near: {0}, Far: {1}, Left: {2}, Right: {3}, Top: {4}, Bottom: {5})",
