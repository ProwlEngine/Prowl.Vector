...
namespace Prowl.Vector.Geometry
{
    ...
    public struct FrustrumDouble : IEquatable<FrustrumDouble>, IFormattable
    {
                                               ...
                                               double fovY, double aspect, double nearDist, double farDist)
        {
            ...
            PlaneDouble p_left = new PlaneDouble(leftNormal, Maths.Dot(leftNormal, position));
            PlaneDouble p_right = new PlaneDouble(rightNormal, Maths.Dot(rightNormal, position));
            PlaneDouble p_top = new PlaneDouble(topNormal, Maths.Dot(topNormal, position));
            PlaneDouble p_bottom = new PlaneDouble(bottomNormal, Maths.Dot(bottomNormal, position));
            
            return new FrustrumDouble(near, far, p_left, p_right, p_top, p_bottom);
        }
