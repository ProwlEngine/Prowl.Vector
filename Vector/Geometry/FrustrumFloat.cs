...
namespace Prowl.Vector.Geometry
{
    ...
    public struct FrustrumFloat : IEquatable<FrustrumFloat>, IFormattable
    {
                                               ...
                                               float fovY, float aspect, float nearDist, float farDist)
        {
            ...
            PlaneFloat p_left = new PlaneFloat(leftNormal, Maths.Dot(leftNormal, position));
            PlaneFloat p_right = new PlaneFloat(rightNormal, Maths.Dot(rightNormal, position));
            PlaneFloat p_top = new PlaneFloat(topNormal, Maths.Dot(topNormal, position));
            PlaneFloat p_bottom = new PlaneFloat(bottomNormal, Maths.Dot(bottomNormal, position));
            
            return new FrustrumFloat(near, far, p_left, p_right, p_top, p_bottom);
        }
