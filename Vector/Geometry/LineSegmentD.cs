...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct LineSegmentD : IEquatable<LineSegmentD>, IFormattable
    {
        ...
        public LineSegmentD(Double3 start, Double3 end)
        {
            Start = start;
            End = end;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentD(double startX, double startY, double startZ, double endX, double endY, double endZ)
        {
        ...
        public Double3 ClosestPointTo(Double3 point)
        {
            ...
            IntersectionD.ClosestPointOnLineSegmentToPoint(Start, End, point, out closestPoint);
            return closestPoint;
        }
        ...
        {
            return IntersectionD.DistanceSqPointToLineSegment(Start, End, point);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool IntersectsPlane(PlaneD plane, out Double3 intersectionPoint)
        {
            return IntersectionD.LineSegmentPlane(Start, End, plane.Normal, plane.D, out intersectionPoint);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetClosestPoints(LineSegmentD other, out Double3 point1, out Double3 point2, out double t1, out double t2)
        {
            IntersectionD.ClosestPointsLineSegmentLineSegment(Start, End, other.Start, other.End, out point1, out point2, out t1, out t2);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double GetSqrDistanceToSegment(LineSegmentD other)
        {
            return IntersectionD.DistanceSqSegmentSegment(Start, End, other.Start, other.End);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double GetDistanceToSegment(LineSegmentD other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentD Extended(double startExtension, double endExtension)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentD Reversed()
        {
            return new LineSegmentD(End, Start);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentD Transform(Double4x4 matrix)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LineSegmentD FromRay(RayD ray, double length)
        {
            return new LineSegmentD(ray.Origin, ray.Origin + ray.Direction * length);
        }

        // --- IEquatable & IFormattable Implementation ---
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(LineSegmentD other) => Start.Equals(other.Start) && End.Equals(other.End);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is LineSegmentD other && Equals(other);
        ...
        public static bool operator ==(LineSegmentD left, LineSegmentD right) => left.Equals(right);
        public static bool operator !=(LineSegmentD left, LineSegmentD right) => !left.Equals(right);
    }
}
