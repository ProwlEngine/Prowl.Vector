...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct LineSegmentDouble : IEquatable<LineSegmentDouble>, IFormattable
    {
        ...
        public LineSegmentDouble(Double3 start, Double3 end)
        {
            Start = start;
            End = end;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentDouble(double startX, double startY, double startZ, double endX, double endY, double endZ)
        {
        ...
        public Double3 ClosestPointTo(Double3 point)
        {
            ...
            IntersectionDouble.ClosestPointOnLineSegmentToPoint(Start, End, point, out closestPoint);
            return closestPoint;
        }
        ...
        public double GetClosestParameter(Double3 point)
        {
            ...
            double lengthSq = Maths.LengthSquared(direction);
            
            if (lengthSq < double.Epsilon * double.Epsilon)
                return 0.0; // Degenerate segment
            
            double t = Maths.Dot(point - Start, direction) / lengthSq;
        ...
        {
            return IntersectionDouble.DistanceSqPointToLineSegment(Start, End, point);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool IntersectsPlane(PlaneDouble plane, out Double3 intersectionPoint)
        {
            return IntersectionDouble.LineSegmentPlane(Start, End, plane.Normal, plane.D, out intersectionPoint);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetClosestPoints(LineSegmentDouble other, out Double3 point1, out Double3 point2, out double t1, out double t2)
        {
            IntersectionDouble.ClosestPointsLineSegmentLineSegment(Start, End, other.Start, other.End, out point1, out point2, out t1, out t2);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double GetSqrDistanceToSegment(LineSegmentDouble other)
        {
            return IntersectionDouble.DistanceSqSegmentSegment(Start, End, other.Start, other.End);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double GetDistanceToSegment(LineSegmentDouble other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentDouble Extended(double startExtension, double endExtension)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentDouble Reversed()
        {
            return new LineSegmentDouble(End, Start);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentDouble Transform(Double4x4 matrix)
        {
            return new LineSegmentDouble(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LineSegmentDouble FromRay(RayDouble ray, double length)
        {
            return new LineSegmentDouble(ray.Origin, ray.Origin + ray.Direction * length);
        }

        // --- IEquatable & IFormattable Implementation ---
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(LineSegmentDouble other) => Start.Equals(other.Start) && End.Equals(other.End);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is LineSegmentDouble other && Equals(other);
        ...
        {
            return string.Format(formatProvider, "LineSegmentDouble(Start: {0}, End: {1})", 
                Start.ToString(format, formatProvider), End.ToString(format, formatProvider));
        }

        public static bool operator ==(LineSegmentDouble left, LineSegmentDouble right) => left.Equals(right);
        public static bool operator !=(LineSegmentDouble left, LineSegmentDouble right) => !left.Equals(right);
    }
}
