...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct LineSegmentFloat : IEquatable<LineSegmentFloat>, IFormattable
    {
        ...
        public LineSegmentFloat(Float3 start, Float3 end)
        {
            Start = start;
            End = end;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentFloat(float startX, float startY, float startZ, float endX, float endY, float endZ)
        {
        ...
        {
            Float3 closestPoint;
            IntersectionFloat.ClosestPointOnLineSegmentToPoint(Start, End, point, out closestPoint);
            return closestPoint;
        }
        ...
        {
            return IntersectionFloat.DistanceSqPointToLineSegment(Start, End, point);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool IntersectsPlane(PlaneFloat plane, out Float3 intersectionPoint)
        {
            return IntersectionFloat.LineSegmentPlane(Start, End, plane.Normal, plane.D, out intersectionPoint);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void GetClosestPoints(LineSegmentFloat other, out Float3 point1, out Float3 point2, out float t1, out float t2)
        {
            IntersectionFloat.ClosestPointsLineSegmentLineSegment(Start, End, other.Start, other.End, out point1, out point2, out t1, out t2);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float GetSqrDistanceToSegment(LineSegmentFloat other)
        {
            return IntersectionFloat.DistanceSqSegmentSegment(Start, End, other.Start, other.End);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float GetDistanceToSegment(LineSegmentFloat other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentFloat Extended(float startExtension, float endExtension)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentFloat Reversed()
        {
            return new LineSegmentFloat(End, Start);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LineSegmentFloat Transform(Float4x4 matrix)
        {
            return new LineSegmentFloat(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static LineSegmentFloat FromRay(RayFloat ray, float length)
        {
            return new LineSegmentFloat(ray.Origin, ray.Origin + ray.Direction * length);
        }

        // --- IEquatable & IFormattable Implementation ---
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(LineSegmentFloat other) => Start.Equals(other.Start) && End.Equals(other.End);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is LineSegmentFloat other && Equals(other);
        ...
        {
            return string.Format(formatProvider, "LineSegmentFloat(Start: {0}, End: {1})", 
                Start.ToString(format, formatProvider), End.ToString(format, formatProvider));
        }

        public static bool operator ==(LineSegmentFloat left, LineSegmentFloat right) => left.Equals(right);
        public static bool operator !=(LineSegmentFloat left, LineSegmentFloat right) => !left.Equals(right);
    }
}
