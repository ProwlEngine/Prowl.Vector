...
namespace Prowl.Vector.Geometry
{
    ...
    public struct PlaneD : IEquatable<PlaneD>, IFormattable
    {
        ...
        public PlaneD(Double3 normal, double d)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PlaneD(Double3 point1, Double3 point2, Double3 point3)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PlaneD FromNormalAndPoint(Double3 normal, Double3 pointOnPlane)
        {
            Double3 normalizedNormal = Maths.Normalize(normal);
            return new PlaneD(normalizedNormal, Maths.Dot(normalizedNormal, pointOnPlane));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PlaneD Translated(Double3 translation)
        {
            return new PlaneD(Normal, D + Maths.Dot(Normal, translation));
        }

        // --- IEquatable & IFormattable Implementation ---
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(PlaneD other) => Normal.Equals(other.Normal) && D.Equals(other.D);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is PlaneD other && Equals(other);
        ...
        public static bool operator ==(PlaneD left, PlaneD right) => left.Equals(right);
        public static bool operator !=(PlaneD left, PlaneD right) => !left.Equals(right);
    }
}
