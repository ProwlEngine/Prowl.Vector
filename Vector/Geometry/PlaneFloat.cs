...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct PlaneFloat : IEquatable<PlaneFloat>, IFormattable
    {
        ...
        public PlaneFloat(Float3 normal, float d)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PlaneFloat(Float3 point1, Float3 point2, Float3 point3)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static PlaneFloat FromNormalAndPoint(Float3 normal, Float3 pointOnPlane)
        {
            Float3 normalizedNormal = Maths.Normalize(normal);
            return new PlaneFloat(normalizedNormal, Maths.Dot(normalizedNormal, pointOnPlane));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PlaneFloat Flipped()
        {
            return new PlaneFloat(-Normal, -D);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PlaneFloat Translated(Float3 translation)
        {
            return new PlaneFloat(Normal, D + Maths.Dot(Normal, translation));
        }

        // --- IEquatable & IFormattable Implementation ---
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(PlaneFloat other) => Normal.Equals(other.Normal) && D.Equals(other.D);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is PlaneFloat other && Equals(other);
        ...
        {
            return string.Format(formatProvider, "PlaneFloat(Normal: {0}, D: {1})", 
                Normal.ToString(format, formatProvider), D.ToString(format, formatProvider));
        }

        public static bool operator ==(PlaneFloat left, PlaneFloat right) => left.Equals(right);
        public static bool operator !=(PlaneFloat left, PlaneFloat right) => !left.Equals(right);
    }
}
