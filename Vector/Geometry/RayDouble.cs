...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct RayDouble : IEquatable<RayDouble>, IFormattable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the RayDouble struct.
        ...
        public RayDouble(Double3 origin, Double3 direction)
        {
            Origin = origin;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Intersects(PlaneDouble plane, out double distance)
        {
            return IntersectionDouble.RayPlane(Origin, Direction, plane.Normal, plane.D, out distance);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Intersects(TriangleDouble triangle, out double distance, out double u, out double v)
        {
            return IntersectionDouble.RayTriangle(Origin, Direction, triangle.V0, triangle.V1, triangle.V2, out distance, out u, out v);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Intersects(AABBDouble aabb, out double tMin, out double tMax)
        {
            return IntersectionDouble.RayAABB(Origin, Direction, aabb.Min, aabb.Max, out tMin, out tMax);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Intersects(SphereDouble sphere, out double t0, out double t1)
        {
            return IntersectionDouble.RaySphere(Origin, Direction, sphere.Center, sphere.Radius, out t0, out t1);
        }
        ...
        public static RayDouble ScreenPointToRay(Double2 screenPosition, Double4x4 viewMatrix, Double4x4 projectionMatrix, double viewportWidth, double viewportHeight)
        {
            ...
            catch (ArgumentException ex)
            {
                ...
                return new RayDouble(Double3.Zero, new Double3(0.0, 0.0, -1.0)); // Fallback ray
            }
            ...
            return new RayDouble(rayOrigin, rayDirection);
        }
        ...
        public static RayDouble ScreenPointToRayFromCamera(Double2 screenPosition, Double3 cameraWorldPosition, Double4x4 viewMatrix, Double4x4 projectionMatrix, double viewportWidth, double viewportHeight)
        {
            double ndcX = (2.0 * screenPosition.X) / viewportWidth - 1.0;
            ...
            catch (ArgumentException ex)
            {
                ...
                return new RayDouble(cameraWorldPosition, new Double3(0.0, 0.0, -1.0)); // Fallback ray
            }
            ...
            return new RayDouble(cameraWorldPosition, direction);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(RayDouble other) => Origin.Equals(other.Origin) && Direction.Equals(other.Direction);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is RayDouble other && Equals(other);
        ...
        {
            return string.Format(formatProvider, "RayDouble(Origin: {0}, Direction: {1})", Origin.ToString(format, formatProvider), Direction.ToString(format, formatProvider));
        }

        public static bool operator ==(RayDouble left, RayDouble right) => left.Equals(right);
        public static bool operator !=(RayDouble left, RayDouble right) => !left.Equals(right);
    }
}
