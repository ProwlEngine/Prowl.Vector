...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct RectD : IEquatable<RectD>, IFormattable
    {
        ...
        public RectD(Double2 min, Double2 max)
        {
            Min = new Double2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RectD FromCenterAndSize(Double2 center, Double2 size)
        {
            Double2 halfSize = size / 2.0;
            return new RectD(center - halfSize, center + halfSize);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Encapsulate(RectD other)
        {
            Min = new Double2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectD Encapsulating(Double2 point)
        {
            var result = this;
        ...
        /// <returns>The encapsulating rectangle.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectD Encapsulating(RectD other)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectD Expanded(double amount)
        {
            var result = this;
        ...
        /// <returns>The expanded rectangle.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectD Expanded(Double2 expansion)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(RectD other) => Min.Equals(other.Min) && Max.Equals(other.Max);
