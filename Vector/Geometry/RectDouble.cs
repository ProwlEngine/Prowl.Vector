...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct RectDouble : IEquatable<RectDouble>, IFormattable
    {
        ...
        public RectDouble(Double2 min, Double2 max)
        {
            Min = new Double2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectDouble(double minX, double minY, double maxX, double maxY)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RectDouble FromCenterAndSize(Double2 center, Double2 size)
        {
            Double2 halfSize = size / 2.0;
            return new RectDouble(center - halfSize, center + halfSize);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Encapsulate(RectDouble other)
        {
            Min = new Double2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectDouble Encapsulating(Double2 point)
        {
            var result = this;
        ...
        /// <returns>The encapsulating rectangle.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectDouble Encapsulating(RectDouble other)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectDouble Expanded(double amount)
        {
            var result = this;
        ...
        /// <returns>The expanded rectangle.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectDouble Expanded(Double2 expansion)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(RectDouble other) => Min.Equals(other.Min) && Max.Equals(other.Max);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is RectDouble other && Equals(other);
        ...
        {
            return string.Format(formatProvider, "RectDouble(Min: {0}, Max: {1})",
                Min.ToString(format, formatProvider), Max.ToString(format, formatProvider));
        }

        public static bool operator ==(RectDouble left, RectDouble right) => left.Equals(right);
        public static bool operator !=(RectDouble left, RectDouble right) => !left.Equals(right);
    }
}
