...
namespace Prowl.Vector.Geometry
{
    ...
    public struct RectFloat : IEquatable<RectFloat>, IFormattable
    {
        ...
        public RectFloat(Float2 min, Float2 max)
        {
            Min = new Float2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectFloat(float minX, float minY, float maxX, float maxY)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RectFloat FromCenterAndSize(Float2 center, Float2 size)
        {
            Float2 halfSize = size / 2f;
            return new RectFloat(center - halfSize, center + halfSize);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Encapsulate(RectFloat other)
        {
            Min = new Float2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectFloat Encapsulating(Float2 point)
        {
            var result = this;
        ...
        /// <returns>The encapsulating rectangle.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectFloat Encapsulating(RectFloat other)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectFloat Expanded(float amount)
        {
            var result = this;
        ...
        /// <returns>The expanded rectangle.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectFloat Expanded(Float2 expansion)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(RectFloat other) => Min.Equals(other.Min) && Max.Equals(other.Max);
        ...
        {
            return string.Format(formatProvider, "RectFloat(Min: {0}, Max: {1})",
                Min.ToString(format, formatProvider), Max.ToString(format, formatProvider));
        }

        public static bool operator ==(RectFloat left, RectFloat right) => left.Equals(right);
        public static bool operator !=(RectFloat left, RectFloat right) => !left.Equals(right);
    }
}
