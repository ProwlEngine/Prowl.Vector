...
namespace Prowl.Vector.Geometry
{
    ...
    public struct RectInt : IEquatable<RectInt>, IFormattable
    {
        ...
        public RectInt(Int2 min, Int2 max)
        {
            Min = new Int2(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static RectInt FromCenterAndSize(Int2 center, Int2 size)
        {
            Int2 halfSize = size / 2;
            return new RectInt(center - halfSize, center + halfSize);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectInt Encapsulating(Int2 point)
        {
            var result = this;
        ...
        /// <returns>The encapsulating rectangle.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectInt Encapsulating(RectInt other)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectInt Expanded(int amount)
        {
            var result = this;
        ...
        /// <returns>The expanded rectangle.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectInt Expanded(Int2 expansion)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(RectInt other) => Min.Equals(other.Min) && Max.Equals(other.Max);
