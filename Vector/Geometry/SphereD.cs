...
namespace Prowl.Vector.Geometry
{
    ...
    public struct SphereD : IEquatable<SphereD>, IFormattable
    {
        ...
        public SphereD(Double3 center, double radius)
        {
            Center = center;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Contains(SphereD other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Intersects(SphereD other)
        {
            return IntersectionD.SphereSphereOverlap(Center, Radius, other.Center, other.Radius);
        }
        ...
        {
            return IntersectionD.SphereAABBOverlap(Center, Radius, aabb.Min, aabb.Max);
        }
        ...
        public Double3 ClosestPointTo(Double3 point)
        {
            ...
            IntersectionD.ClosestPointOnSphereToPoint(point, Center, Radius, out closestPoint);
            return closestPoint;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Encapsulate(SphereD other)
        {
            double distance = Maths.Length(other.Center - Center);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SphereD Encapsulating(Double3 point)
        {
            var result = this;
        ...
        /// <returns>The encapsulating sphere.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SphereD Encapsulating(SphereD other)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SphereD Transform(Double4x4 matrix)
        {
            ...
            return new SphereD(transformedCenter, transformedRadius);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SphereD FromDiameter(Double3 pointA, Double3 pointB)
        {
        ...
        public static SphereD FromPoints(Double3[] points)
        {
            if (points == null || points.Length == 0)
                return new SphereD(Double3.Zero, 0.0);
            
            if (points.Length == 1)
                return new SphereD(points[0], 0.0);
            ...
            return new SphereD(centroid, Maths.Sqrt(maxDistSq));
        }

        // --- IEquatable & IFormattable Implementation ---
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(SphereD other) => Center.Equals(other.Center) && Radius.Equals(other.Radius);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is SphereD other && Equals(other);
        ...
        public static bool operator ==(SphereD left, SphereD right) => left.Equals(right);
        public static bool operator !=(SphereD left, SphereD right) => !left.Equals(right);
    }
}
