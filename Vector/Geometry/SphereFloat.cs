...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct SphereFloat : IEquatable<SphereFloat>, IFormattable
    {
        ...
        public SphereFloat(Float3 center, float radius)
        {
            Center = center;
        ...
        /// <param name="radius">The radius of the sphere.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SphereFloat(float x, float y, float z, float radius)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Contains(SphereFloat other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Intersects(SphereFloat other)
        {
            return IntersectionFloat.SphereSphereOverlap(Center, Radius, other.Center, other.Radius);
        }
        ...
        {
            return IntersectionFloat.SphereAABBOverlap(Center, Radius, aabb.Min, aabb.Max);
        }
        ...
        {
            Float3 closestPoint;
            IntersectionFloat.ClosestPointOnSphereToPoint(point, Center, Radius, out closestPoint);
            return closestPoint;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Encapsulate(SphereFloat other)
        {
            float distance = Maths.Length(other.Center - Center);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SphereFloat Encapsulating(Float3 point)
        {
            var result = this;
        ...
        /// <returns>The encapsulating sphere.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SphereFloat Encapsulating(SphereFloat other)
        {
            var result = this;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SphereFloat Transform(Float4x4 matrix)
        {
            ...
            return new SphereFloat(transformedCenter, transformedRadius);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Float3 SampleSurface(float u, float v)
        {
        ...
        public Float3 SampleVolume(float u, float v, float w)
        {
            ...
            Float3 direction = SampleSurface(v, w) - Center;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SphereFloat FromDiameter(Float3 pointA, Float3 pointB)
        {
            Float3 center = (pointA + pointB) / 2f;
            float radius = Maths.Length(pointB - pointA) / 2f;
            return new SphereFloat(center, radius);
        }
        ...
        public static SphereFloat FromPoints(Float3[] points)
        {
            if (points == null || points.Length == 0)
                return new SphereFloat(Float3.Zero, 0f);
            
            if (points.Length == 1)
                return new SphereFloat(points[0], 0f);
            ...
            return new SphereFloat(centroid, Maths.Sqrt(maxDistSq));
        }

        // --- IEquatable & IFormattable Implementation ---
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(SphereFloat other) => Center.Equals(other.Center) && Radius.Equals(other.Radius);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is SphereFloat other && Equals(other);
        ...
        {
            return string.Format(formatProvider, "SphereFloat(Center: {0}, Radius: {1})", 
                Center.ToString(format, formatProvider), Radius.ToString(format, formatProvider));
        }

        public static bool operator ==(SphereFloat left, SphereFloat right) => left.Equals(right);
        public static bool operator !=(SphereFloat left, SphereFloat right) => !left.Equals(right);
    }
}
