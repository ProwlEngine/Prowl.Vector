...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct SplineD : IEquatable<SplineD>, IFormattable
    {
        /// <summary>
        ...
        public SplineD(Double3[] controlPoints, SplineType type = SplineType.CatmullRom, bool closed = false, double tension = 0.0)
        {
        ...
        /// <param name="closed">Whether the spline should be closed.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SplineD(Double3[] controlPoints, Double3[] tangents, bool closed = false)
        {
            ControlPoints = controlPoints ?? throw new ArgumentNullException(nameof(controlPoints));
       ...
       public AABBD GetBounds(int subdivisions = 100)
       {
           if (ControlPoints == null || ControlPoints.Length == 0)
               return new AABBD(Double3.Zero, Double3.Zero);
       ...
       public static SplineD CreateLinear(Double3[] points, bool closed = false)
       {
           return new SplineD(points, SplineType.Linear, closed);
       }
       ...
       public static SplineD CreateCatmullRom(Double3[] points, bool closed = false, double tension = 0.0)
       {
           return new SplineD(points, SplineType.CatmullRom, closed, tension);
       }
       ...
       public static SplineD CreateBezier(Double3[] points)
       {
           if ((points.Length - 1) % 3 != 0)
               throw new ArgumentException("Bezier splines require 3n+1 control points for n segments");

           return new SplineD(points, SplineType.Bezier, false);
       }
       ...
       public static SplineD CreateBSpline(Double3[] points, bool closed = false)
       {
           return new SplineD(points, SplineType.BSpline, closed);
       }
       ...
       public static SplineD CreateHermite(Double3[] points, bool closed = false)
       {
           return new SplineD(points, SplineType.Hermite, closed);
       }
       ...
       public static SplineD CreateHermiteWithTangents(Double3[] points, Double3[] tangents, bool closed = false)
       {
           return new SplineD(points, tangents, closed);
       }
       ...
       public static SplineD CreateCircularArc(Double3 center, double radius, double startAngle, double endAngle, int segments = 16)
       {
       ...
       public static SplineD CreateHelix(Double3 center, double radius, double pitch, double turns, int segments = 16)
       {
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public bool Equals(SplineD other)
       {
       ...
       [MethodImpl(MethodImplOptions.AggressiveInlining)]
       public override bool Equals(object? obj) => obj is SplineD other && Equals(other);
       ...
       public static bool operator ==(SplineD left, SplineD right) => left.Equals(right);
       public static bool operator !=(SplineD left, SplineD right) => !left.Equals(right);
   }
}
