...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct TriangleD : IEquatable<TriangleD>, IFormattable
    {
        ...
        public TriangleD(Double3 v0, Double3 v1, Double3 v2)
        {
            V0 = v0;
            V1 = v1;
            V2 = v2;
        ...
        {
            return PlaneD.FromNormalAndPoint(NormalizedNormal, V0);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TriangleD Transform(Double4x4 matrix)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TriangleD Reversed()
        {
            return new TriangleD(V0, V2, V1);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool IntersectsWith(TriangleD other)
        {
            return IntersectionD.TriangleTriangle(V0, V1, V2, other.V0, other.V1, other.V2);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(TriangleD other) => V0.Equals(other.V0) && V1.Equals(other.V1) && V2.Equals(other.V2);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is TriangleD other && Equals(other);
        ...
        public static bool operator ==(TriangleD left, TriangleD right) => left.Equals(right);
        public static bool operator !=(TriangleD left, TriangleD right) => !left.Equals(right);
    }
}
