...
namespace Prowl.Vector.Geometry
{
    ...
    /// </summary>
    public struct TriangleDouble : IEquatable<TriangleDouble>, IFormattable
    {
        ...
        public TriangleDouble(Double3 v0, Double3 v1, Double3 v2)
        {
            V0 = v0;
            V1 = v1;
            V2 = v2;
        ...
        public void GetBarycentricCoordinates(Double3 point, out double u, out double v)
        {
            ...
            double dot00 = Maths.Dot(v0v2, v0v2);
            double dot01 = Maths.Dot(v0v2, v0v1);
            double dot02 = Maths.Dot(v0v2, v0p);
            double dot11 = Maths.Dot(v0v1, v0v1);
            double dot12 = Maths.Dot(v0v1, v0p);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PlaneDouble GetPlane()
        {
            return PlaneDouble.FromNormalAndPoint(NormalizedNormal, V0);
        }
        ...
        {
            return Maths.LengthSquared(Normal) < double.Epsilon * double.Epsilon;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TriangleDouble Transform(Double4x4 matrix)
        {
        ...
        public bool IsCoplanar(Double3 point, double tolerance = double.Epsilon)
        {
            ...
            double distance = Maths.Abs(Maths.Dot(normal, point - V0));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TriangleDouble Reversed()
        {
            return new TriangleDouble(V0, V2, V1);
        }
        ...
        public Double3 GetCircumcenter()
        {
            Double3 a = V1 - V0;
            Double3 b = V2 - V0;
            Double3 cross = Maths.Cross(a, b);
            double denom = 2.0 * Maths.Dot(cross, cross);
            
            if (Maths.Abs(denom) < double.Epsilon)
                return Centroid; // Fallback for degenerate triangle
                
            Double3 result = Maths.Cross(Maths.Cross(cross, a) * Maths.LengthSquared(b) + 
        ...
        {
            double a = Maths.Length(V1 - V2);
            double b = Maths.Length(V2 - V0);
            double c = Maths.Length(V0 - V1);
            double area = Area;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool IntersectsWith(TriangleDouble other)
        {
            return IntersectionDouble.TriangleTriangle(V0, V1, V2, other.V0, other.V1, other.V2);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(TriangleDouble other) => V0.Equals(other.V0) && V1.Equals(other.V1) && V2.Equals(other.V2);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is TriangleDouble other && Equals(other);
        ...
        {
            return string.Format(formatProvider, "TriangleDouble(V0: {0}, V1: {1}, V2: {2})", 
                V0.ToString(format, formatProvider), V1.ToString(format, formatProvider), V2.ToString(format, formatProvider));
        }

        public static bool operator ==(TriangleDouble left, TriangleDouble right) => left.Equals(right);
        public static bool operator !=(TriangleDouble left, TriangleDouble right) => !left.Equals(right);
    }
}
