...
namespace Prowl.Vector
{
    ...
    public static class MathD
    {
        ...
        [MethodImpl(IN)] public static Vector2 Lerp(Vector2 a, Vector2 b, Vector2 t) => new Vector2(Lerp(a.x, b.x, t.x), Lerp(a.y, b.y, t.y));

        [MethodImpl(IN)] public static Vector3 Lerp(Vector3 a, Vector3 b, Vector3 t) => new Vector3(Lerp(a.x, b.x, t.x), Lerp(a.y, b.y, t.y), Lerp(a.z, b.z, t.z));

        [MethodImpl(IN)] public static Vector4 Lerp(Vector4 a, Vector4 b, Vector4 t) => new Vector4(Lerp(a.x, b.x, t.x), Lerp(a.y, b.y, t.y), Lerp(a.z, b.z, t.z), Lerp(a.w, b.w, t.w));
        ...
        [MethodImpl(IN)] public static Vector3 ToDeg(this Vector3 v) => new Vector3(v.x * Rad2Deg, v.y * Rad2Deg, v.z * Rad2Deg);

        [MethodImpl(IN)] public static Vector3 ToRad(this Vector3 v) => new Vector3(v.x * Deg2Rad, v.y * Deg2Rad, v.z * Deg2Rad);
