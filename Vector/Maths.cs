...
public static partial class Maths
{
	...
	// TransformNormal functions
        ...
        public static Float2 TransformNormal(Float2 normal, Float2x2 matrix)
        {
            ...
            Float2x2 invTranspose = Transpose(Inverse(matrix));
        ...
        {
            // For normals, we need to use the inverse transpose of the matrix
            Float3x3 invTranspose = Transpose(Inverse(matrix));
        ...
        {
            // For normals, we need to use the inverse transpose of the matrix
            Double2x2 invTranspose = Transpose(Inverse(matrix));
        ...
        {
            // For normals, we need to use the inverse transpose of the matrix
            Double3x3 invTranspose = Transpose(Inverse(matrix));
