...
[System.Serializable]
public partial struct Bool3x4 : System.IEquatable<Bool3x4>, IFormattable
{
	...
	/// <summary>Bool3x4 zero value.</summary>
	public static readonly Bool3x4 Zero = new Bool3x4(new Bool3(false), new Bool3(false), new Bool3(false), new Bool3(false));

	/// <summary>Constructs a Bool3x4 matrix from 4 Bool3 vectors.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Bool3x4(Bool3 col0, Bool3 col1, Bool3 col2, Bool3 col3)
	{
		this.c0 = col0;
		this.c1 = col1;
		this.c2 = col2;
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x4 operator &(Bool3x4 lhs, Bool3x4 rhs) => new Bool3x4(lhs.c0 & rhs.c0, lhs.c1 & rhs.c1, lhs.c2 & rhs.c2, lhs.c3 & rhs.c3);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x4 operator !(Bool3x4 val) => new Bool3x4(!val.c0, !val.c1, !val.c2, !val.c3);

	/// <summary>Returns true if all components are equal.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator ==(Bool3x4 lhs, Bool3x4 rhs) => lhs.c0 == rhs.c0 && lhs.c1 == rhs.c1 && lhs.c2 == rhs.c2 && lhs.c3 == rhs.c3;

	/// <summary>Returns true if any component is not equal.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator !=(Bool3x4 lhs, Bool3x4 rhs) => !(lhs == rhs);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public bool Equals(Bool3x4 rhs) { return this.c0.Equals(rhs.c0) && this.c1.Equals(rhs.c1) && this.c2.Equals(rhs.c2) && this.c3.Equals(rhs.c3); }
