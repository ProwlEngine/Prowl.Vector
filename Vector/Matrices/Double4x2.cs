...
public partial struct Double4x2 : System.IEquatable<Double4x2>, IFormattable
{
	...
	public static readonly Double4x2 Zero = new Double4x2(Double4.Zero, Double4.Zero);

	/// <summary>Constructs a Double4x2 matrix from 2 Double4 vectors.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Double4x2(Double4 col0, Double4 col1)
	{
		this.c0 = col0;
		this.c1 = col1;
	}
	...
	/// <summary>Constructs a Double4x2 from a Float4x2 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Double4x2(Float4x2 m)
	{
		this.c0 = new Double4(m.c0);
		this.c1 = new Double4(m.c1);
	}

	/// <summary>Constructs a Double4x2 from a Int4x2 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Double4x2(Int4x2 m)
	{
		this.c0 = new Double4(m.c0);
		this.c1 = new Double4(m.c1);
	}

	/// <summary>Constructs a Double4x2 from a UInt4x2 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Double4x2(UInt4x2 m)
	{
		this.c0 = new Double4(m.c0);
		this.c1 = new Double4(m.c1);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Double4x2 operator +(Double4x2 lhs, Double4x2 rhs) => new Double4x2(lhs.c0 + rhs.c0, lhs.c1 + rhs.c1);

	/// <summary>Returns the component-wise + of matrix and scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Double4x2 operator +(Double4x2 lhs, double rhs) => new Double4x2(lhs.c0 + rhs, lhs.c1 + rhs);

	/// <summary>Returns the component-wise + of scalar and matrix.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Double4x2 operator +(double lhs, Double4x2 rhs) => new Double4x2(lhs + rhs.c0, lhs + rhs.c1);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Double4x2 operator -(Double4x2 val) => new Double4x2(-val.c0, -val.c1);

	/// <summary>Returns a Bool4x2 indicating component-wise < comparison.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool4x2 operator <(Double4x2 lhs, Double4x2 rhs) => new Bool4x2(lhs.c0 < rhs.c0, lhs.c1 < rhs.c1);

	/// <summary>Returns a Bool4x2 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool4x2 operator <(Double4x2 lhs, double rhs) => new Bool4x2(lhs.c0 < rhs, lhs.c1 < rhs);

	/// <summary>Returns a Bool4x2 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool4x2 operator <(double lhs, Double4x2 rhs) => new Bool4x2(lhs < rhs.c0, lhs < rhs.c1);
	...
	/// <summary>Implicitly converts a Float4x2 to a Double4x2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double4x2(Float4x2 m)
	{
		return new Double4x2((Double4)m.c0, (Double4)m.c1);
	}

	/// <summary>Implicitly converts a Int4x2 to a Double4x2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double4x2(Int4x2 m)
	{
		return new Double4x2((Double4)m.c0, (Double4)m.c1);
	}

	/// <summary>Implicitly converts a UInt4x2 to a Double4x2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double4x2(UInt4x2 m)
	{
		return new Double4x2((Double4)m.c0, (Double4)m.c1);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Double2 GetRow2()
	{
		return new Double2(c0.Z, c1.Z);
	}

	/// <summary>Sets row 2 of the matrix.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void SetRow2(Double2 value)
	{
		c0.Z = value.X;
		c1.Z = value.Y;
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Double2 GetRow3()
	{
		return new Double2(c0.W, c1.W);
	}

	/// <summary>Sets row 3 of the matrix.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void SetRow3(Double2 value)
	{
		c0.W = value.X;
		c1.W = value.Y;
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public bool Equals(Double4x2 rhs) { return this.c0.Equals(rhs.c0) && this.c1.Equals(rhs.c1); }
