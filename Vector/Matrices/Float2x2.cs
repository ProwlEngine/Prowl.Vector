...
namespace Prowl.Vector
{
    ...
    public partial struct Float2x2 : System.IEquatable<Float2x2>, IFormattable
    {
        ...
        /// <summary>Returns the product of two Float2x2 matrices.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float2x2 operator *(Float2x2 lhs, Float2x2 rhs)
        {
            return new Float2x2(
                new Float2((lhs.c0.X * rhs.c0.X + lhs.c1.X * rhs.c0.Y), (lhs.c0.Y * rhs.c0.X + lhs.c1.Y * rhs.c0.Y)),
                new Float2((lhs.c0.X * rhs.c1.X + lhs.c1.X * rhs.c1.Y), (lhs.c0.Y * rhs.c1.X + lhs.c1.Y * rhs.c1.Y))
            );
        }
