...
public partial struct Int2x2 : System.IEquatable<Int2x2>, IFormattable
{
	...
	/// <summary>Constructs a Int2x2 from a Float2x2 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int2x2(Float2x2 m)
	{
		this.c0 = new Int2(m.c0);
		this.c1 = new Int2(m.c1);
	}

	/// <summary>Constructs a Int2x2 from a Double2x2 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int2x2(Double2x2 m)
	{
		this.c0 = new Int2(m.c0);
		this.c1 = new Int2(m.c1);
	}

	/// <summary>Constructs a Int2x2 from a UInt2x2 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int2x2(UInt2x2 m)
	{
		this.c0 = new Int2(m.c0);
		this.c1 = new Int2(m.c1);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int2x2 operator +(Int2x2 lhs, Int2x2 rhs) => new Int2x2(lhs.c0 + rhs.c0, lhs.c1 + rhs.c1);

	/// <summary>Returns the component-wise + of matrix and scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int2x2 operator +(Int2x2 lhs, int rhs) => new Int2x2(lhs.c0 + rhs, lhs.c1 + rhs);

	/// <summary>Returns the component-wise + of scalar and matrix.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int2x2 operator +(int lhs, Int2x2 rhs) => new Int2x2(lhs + rhs.c0, lhs + rhs.c1);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int2x2 operator ~(Int2x2 val) => new Int2x2(~val.c0, ~val.c1);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool2x2 operator <(Int2x2 lhs, Int2x2 rhs) => new Bool2x2(lhs.c0 < rhs.c0, lhs.c1 < rhs.c1);

	/// <summary>Returns a Bool2x2 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool2x2 operator <(Int2x2 lhs, int rhs) => new Bool2x2(lhs.c0 < rhs, lhs.c1 < rhs);

	/// <summary>Returns a Bool2x2 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool2x2 operator <(int lhs, Int2x2 rhs) => new Bool2x2(lhs < rhs.c0, lhs < rhs.c1);
	...
	/// <summary>Explicitly converts a Float2x2 to a Int2x2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int2x2(Float2x2 m)
	{
		return new Int2x2((Int2)m.c0, (Int2)m.c1);
	}

	/// <summary>Explicitly converts a Double2x2 to a Int2x2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int2x2(Double2x2 m)
	{
		return new Int2x2((Int2)m.c0, (Int2)m.c1);
	}

	/// <summary>Explicitly converts a UInt2x2 to a Int2x2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int2x2(UInt2x2 m)
	{
		return new Int2x2((Int2)m.c0, (Int2)m.c1);
	}
