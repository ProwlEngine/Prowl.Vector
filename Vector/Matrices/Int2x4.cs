...
public partial struct Int2x4 : System.IEquatable<Int2x4>, IFormattable
{
	...
	public static readonly Int2x4 Zero = new Int2x4(Int2.Zero, Int2.Zero, Int2.Zero, Int2.Zero);

	/// <summary>Constructs a Int2x4 matrix from 4 Int2 vectors.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int2x4(Int2 col0, Int2 col1, Int2 col2, Int2 col3)
	{
		this.c0 = col0;
		this.c1 = col1;
		this.c2 = col2;
	...
	/// <summary>Constructs a Int2x4 from a Float2x4 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int2x4(Float2x4 m)
	{
		this.c0 = new Int2(m.c0);
		this.c1 = new Int2(m.c1);
		this.c2 = new Int2(m.c2);
		this.c3 = new Int2(m.c3);
	}

	/// <summary>Constructs a Int2x4 from a Double2x4 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int2x4(Double2x4 m)
	{
		this.c0 = new Int2(m.c0);
		this.c1 = new Int2(m.c1);
		this.c2 = new Int2(m.c2);
	...
	/// <summary>Constructs a Int2x4 from a UInt2x4 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int2x4(UInt2x4 m)
	{
		this.c0 = new Int2(m.c0);
		this.c1 = new Int2(m.c1);
		this.c2 = new Int2(m.c2);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int2x4 operator +(Int2x4 lhs, Int2x4 rhs) => new Int2x4(lhs.c0 + rhs.c0, lhs.c1 + rhs.c1, lhs.c2 + rhs.c2, lhs.c3 + rhs.c3);

	/// <summary>Returns the component-wise + of matrix and scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int2x4 operator +(Int2x4 lhs, int rhs) => new Int2x4(lhs.c0 + rhs, lhs.c1 + rhs, lhs.c2 + rhs, lhs.c3 + rhs);

	/// <summary>Returns the component-wise + of scalar and matrix.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int2x4 operator +(int lhs, Int2x4 rhs) => new Int2x4(lhs + rhs.c0, lhs + rhs.c1, lhs + rhs.c2, lhs + rhs.c3);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int2x4 operator ~(Int2x4 val) => new Int2x4(~val.c0, ~val.c1, ~val.c2, ~val.c3);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool2x4 operator <(Int2x4 lhs, Int2x4 rhs) => new Bool2x4(lhs.c0 < rhs.c0, lhs.c1 < rhs.c1, lhs.c2 < rhs.c2, lhs.c3 < rhs.c3);

	/// <summary>Returns a Bool2x4 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool2x4 operator <(Int2x4 lhs, int rhs) => new Bool2x4(lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs, lhs.c3 < rhs);

	/// <summary>Returns a Bool2x4 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool2x4 operator <(int lhs, Int2x4 rhs) => new Bool2x4(lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2, lhs < rhs.c3);
	...
	/// <summary>Explicitly converts a Float2x4 to a Int2x4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int2x4(Float2x4 m)
	{
		return new Int2x4((Int2)m.c0, (Int2)m.c1, (Int2)m.c2, (Int2)m.c3);
	}

	/// <summary>Explicitly converts a Double2x4 to a Int2x4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int2x4(Double2x4 m)
	{
		return new Int2x4((Int2)m.c0, (Int2)m.c1, (Int2)m.c2, (Int2)m.c3);
	}

	/// <summary>Explicitly converts a UInt2x4 to a Int2x4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int2x4(UInt2x4 m)
	{
		return new Int2x4((Int2)m.c0, (Int2)m.c1, (Int2)m.c2, (Int2)m.c3);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public bool Equals(Int2x4 rhs) { return this.c0.Equals(rhs.c0) && this.c1.Equals(rhs.c1) && this.c2.Equals(rhs.c2) && this.c3.Equals(rhs.c3); }
