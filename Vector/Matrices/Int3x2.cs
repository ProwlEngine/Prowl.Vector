...
public partial struct Int3x2 : System.IEquatable<Int3x2>, IFormattable
{
	...
	/// <summary>Constructs a Int3x2 from a Float3x2 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int3x2(Float3x2 m)
	{
		this.c0 = new Int3(m.c0);
		this.c1 = new Int3(m.c1);
	}

	/// <summary>Constructs a Int3x2 from a Double3x2 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int3x2(Double3x2 m)
	{
		this.c0 = new Int3(m.c0);
		this.c1 = new Int3(m.c1);
	}

	/// <summary>Constructs a Int3x2 from a UInt3x2 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int3x2(UInt3x2 m)
	{
		this.c0 = new Int3(m.c0);
		this.c1 = new Int3(m.c1);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x2 operator +(Int3x2 lhs, Int3x2 rhs) => new Int3x2(lhs.c0 + rhs.c0, lhs.c1 + rhs.c1);

	/// <summary>Returns the component-wise + of matrix and scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x2 operator +(Int3x2 lhs, int rhs) => new Int3x2(lhs.c0 + rhs, lhs.c1 + rhs);

	/// <summary>Returns the component-wise + of scalar and matrix.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x2 operator +(int lhs, Int3x2 rhs) => new Int3x2(lhs + rhs.c0, lhs + rhs.c1);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x2 operator ~(Int3x2 val) => new Int3x2(~val.c0, ~val.c1);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x2 operator <(Int3x2 lhs, Int3x2 rhs) => new Bool3x2(lhs.c0 < rhs.c0, lhs.c1 < rhs.c1);

	/// <summary>Returns a Bool3x2 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x2 operator <(Int3x2 lhs, int rhs) => new Bool3x2(lhs.c0 < rhs, lhs.c1 < rhs);

	/// <summary>Returns a Bool3x2 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x2 operator <(int lhs, Int3x2 rhs) => new Bool3x2(lhs < rhs.c0, lhs < rhs.c1);
	...
	/// <summary>Explicitly converts a Float3x2 to a Int3x2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int3x2(Float3x2 m)
	{
		return new Int3x2((Int3)m.c0, (Int3)m.c1);
	}

	/// <summary>Explicitly converts a Double3x2 to a Int3x2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int3x2(Double3x2 m)
	{
		return new Int3x2((Int3)m.c0, (Int3)m.c1);
	}

	/// <summary>Explicitly converts a UInt3x2 to a Int3x2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int3x2(UInt3x2 m)
	{
		return new Int3x2((Int3)m.c0, (Int3)m.c1);
	}
