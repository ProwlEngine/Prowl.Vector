...
public partial struct Int3x3 : System.IEquatable<Int3x3>, IFormattable
{
	...
	/// <summary>Constructs a Int3x3 from a Float3x3 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int3x3(Float3x3 m)
	{
		this.c0 = new Int3(m.c0);
		this.c1 = new Int3(m.c1);
		this.c2 = new Int3(m.c2);
	}

	/// <summary>Constructs a Int3x3 from a Double3x3 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int3x3(Double3x3 m)
	{
		this.c0 = new Int3(m.c0);
		this.c1 = new Int3(m.c1);
		this.c2 = new Int3(m.c2);
	...
	/// <summary>Constructs a Int3x3 from a UInt3x3 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int3x3(UInt3x3 m)
	{
		this.c0 = new Int3(m.c0);
		this.c1 = new Int3(m.c1);
		this.c2 = new Int3(m.c2);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x3 operator +(Int3x3 lhs, Int3x3 rhs) => new Int3x3(lhs.c0 + rhs.c0, lhs.c1 + rhs.c1, lhs.c2 + rhs.c2);

	/// <summary>Returns the component-wise + of matrix and scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x3 operator +(Int3x3 lhs, int rhs) => new Int3x3(lhs.c0 + rhs, lhs.c1 + rhs, lhs.c2 + rhs);

	/// <summary>Returns the component-wise + of scalar and matrix.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x3 operator +(int lhs, Int3x3 rhs) => new Int3x3(lhs + rhs.c0, lhs + rhs.c1, lhs + rhs.c2);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x3 operator ~(Int3x3 val) => new Int3x3(~val.c0, ~val.c1, ~val.c2);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x3 operator <(Int3x3 lhs, Int3x3 rhs) => new Bool3x3(lhs.c0 < rhs.c0, lhs.c1 < rhs.c1, lhs.c2 < rhs.c2);

	/// <summary>Returns a Bool3x3 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x3 operator <(Int3x3 lhs, int rhs) => new Bool3x3(lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs);

	/// <summary>Returns a Bool3x3 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x3 operator <(int lhs, Int3x3 rhs) => new Bool3x3(lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2);
	...
	/// <summary>Explicitly converts a Float3x3 to a Int3x3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int3x3(Float3x3 m)
	{
		return new Int3x3((Int3)m.c0, (Int3)m.c1, (Int3)m.c2);
	}

	/// <summary>Explicitly converts a Double3x3 to a Int3x3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int3x3(Double3x3 m)
	{
		return new Int3x3((Int3)m.c0, (Int3)m.c1, (Int3)m.c2);
	}

	/// <summary>Explicitly converts a UInt3x3 to a Int3x3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int3x3(UInt3x3 m)
	{
		return new Int3x3((Int3)m.c0, (Int3)m.c1, (Int3)m.c2);
	}
