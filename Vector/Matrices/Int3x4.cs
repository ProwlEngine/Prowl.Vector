...
public partial struct Int3x4 : System.IEquatable<Int3x4>, IFormattable
{
	...
	/// <summary>Constructs a Int3x4 from a Float3x4 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int3x4(Float3x4 m)
	{
		this.c0 = new Int3(m.c0);
		this.c1 = new Int3(m.c1);
		this.c2 = new Int3(m.c2);
		this.c3 = new Int3(m.c3);
	}

	/// <summary>Constructs a Int3x4 from a Double3x4 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int3x4(Double3x4 m)
	{
		this.c0 = new Int3(m.c0);
		this.c1 = new Int3(m.c1);
		this.c2 = new Int3(m.c2);
	...
	/// <summary>Constructs a Int3x4 from a UInt3x4 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Int3x4(UInt3x4 m)
	{
		this.c0 = new Int3(m.c0);
		this.c1 = new Int3(m.c1);
		this.c2 = new Int3(m.c2);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x4 operator +(Int3x4 lhs, Int3x4 rhs) => new Int3x4(lhs.c0 + rhs.c0, lhs.c1 + rhs.c1, lhs.c2 + rhs.c2, lhs.c3 + rhs.c3);

	/// <summary>Returns the component-wise + of matrix and scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x4 operator +(Int3x4 lhs, int rhs) => new Int3x4(lhs.c0 + rhs, lhs.c1 + rhs, lhs.c2 + rhs, lhs.c3 + rhs);

	/// <summary>Returns the component-wise + of scalar and matrix.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x4 operator +(int lhs, Int3x4 rhs) => new Int3x4(lhs + rhs.c0, lhs + rhs.c1, lhs + rhs.c2, lhs + rhs.c3);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Int3x4 operator ~(Int3x4 val) => new Int3x4(~val.c0, ~val.c1, ~val.c2, ~val.c3);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x4 operator <(Int3x4 lhs, Int3x4 rhs) => new Bool3x4(lhs.c0 < rhs.c0, lhs.c1 < rhs.c1, lhs.c2 < rhs.c2, lhs.c3 < rhs.c3);

	/// <summary>Returns a Bool3x4 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x4 operator <(Int3x4 lhs, int rhs) => new Bool3x4(lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs, lhs.c3 < rhs);

	/// <summary>Returns a Bool3x4 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x4 operator <(int lhs, Int3x4 rhs) => new Bool3x4(lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2, lhs < rhs.c3);
	...
	/// <summary>Explicitly converts a Float3x4 to a Int3x4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int3x4(Float3x4 m)
	{
		return new Int3x4((Int3)m.c0, (Int3)m.c1, (Int3)m.c2, (Int3)m.c3);
	}

	/// <summary>Explicitly converts a Double3x4 to a Int3x4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int3x4(Double3x4 m)
	{
		return new Int3x4((Int3)m.c0, (Int3)m.c1, (Int3)m.c2, (Int3)m.c3);
	}

	/// <summary>Explicitly converts a UInt3x4 to a Int3x4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int3x4(UInt3x4 m)
	{
		return new Int3x4((Int3)m.c0, (Int3)m.c1, (Int3)m.c2, (Int3)m.c3);
	}
