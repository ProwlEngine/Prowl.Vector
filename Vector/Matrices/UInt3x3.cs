...
public partial struct UInt3x3 : System.IEquatable<UInt3x3>, IFormattable
{
	...
	/// <summary>Constructs a UInt3x3 from a Float3x3 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public UInt3x3(Float3x3 m)
	{
	...
	/// <summary>Constructs a UInt3x3 from a Double3x3 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public UInt3x3(Double3x3 m)
	{
		this.c0 = new UInt3(m.c0);
		this.c1 = new UInt3(m.c1);
		this.c2 = new UInt3(m.c2);
	...
	/// <summary>Constructs a UInt3x3 from a Int3x3 with type conversion.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public UInt3x3(Int3x3 m)
	{
		this.c0 = new UInt3(m.c0);
		this.c1 = new UInt3(m.c1);
		this.c2 = new UInt3(m.c2);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UInt3x3 operator +(UInt3x3 lhs, UInt3x3 rhs) => new UInt3x3(lhs.c0 + rhs.c0, lhs.c1 + rhs.c1, lhs.c2 + rhs.c2);

	/// <summary>Returns the component-wise + of matrix and scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UInt3x3 operator +(UInt3x3 lhs, uint rhs) => new UInt3x3(lhs.c0 + rhs, lhs.c1 + rhs, lhs.c2 + rhs);

	/// <summary>Returns the component-wise + of scalar and matrix.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UInt3x3 operator +(uint lhs, UInt3x3 rhs) => new UInt3x3(lhs + rhs.c0, lhs + rhs.c1, lhs + rhs.c2);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UInt3x3 operator <<(UInt3x3 lhs, int rhs) => new UInt3x3(lhs.c0 << rhs, lhs.c1 << rhs, lhs.c2 << rhs);
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UInt3x3 operator ~(UInt3x3 val) => new UInt3x3(~val.c0, ~val.c1, ~val.c2);

	/// <summary>Returns a Bool3x3 indicating component-wise < comparison.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x3 operator <(UInt3x3 lhs, UInt3x3 rhs) => new Bool3x3(lhs.c0 < rhs.c0, lhs.c1 < rhs.c1, lhs.c2 < rhs.c2);

	/// <summary>Returns a Bool3x3 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x3 operator <(UInt3x3 lhs, uint rhs) => new Bool3x3(lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs);

	/// <summary>Returns a Bool3x3 indicating component-wise < comparison with scalar.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Bool3x3 operator <(uint lhs, UInt3x3 rhs) => new Bool3x3(lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2);
	...
	/// <summary>Explicitly converts a Float3x3 to a UInt3x3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UInt3x3(Float3x3 m)
	{
		return new UInt3x3((UInt3)m.c0, (UInt3)m.c1, (UInt3)m.c2);
	}

	/// <summary>Explicitly converts a Double3x3 to a UInt3x3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UInt3x3(Double3x3 m)
	{
		return new UInt3x3((UInt3)m.c0, (UInt3)m.c1, (UInt3)m.c2);
	}

	/// <summary>Explicitly converts a Int3x3 to a UInt3x3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UInt3x3(Int3x3 m)
	{
		return new UInt3x3((UInt3)m.c0, (UInt3)m.c1, (UInt3)m.c2);
	}
