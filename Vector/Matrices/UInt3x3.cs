...
namespace Prowl.Vector
{
    ...
    public partial struct UInt3x3 : System.IEquatable<UInt3x3>, IFormattable
    {
        ...
        /// <summary>Returns the product of two UInt3x3 matrices.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UInt3x3 operator *(UInt3x3 lhs, UInt3x3 rhs)
        {
            return new UInt3x3(
                new UInt3((lhs.c0.X * rhs.c0.X + lhs.c1.X * rhs.c0.Y + lhs.c2.X * rhs.c0.Z), (lhs.c0.Y * rhs.c0.X + lhs.c1.Y * rhs.c0.Y + lhs.c2.Y * rhs.c0.Z), (lhs.c0.Z * rhs.c0.X + lhs.c1.Z * rhs.c0.Y + lhs.c2.Z * rhs.c0.Z)),
                new UInt3((lhs.c0.X * rhs.c1.X + lhs.c1.X * rhs.c1.Y + lhs.c2.X * rhs.c1.Z), (lhs.c0.Y * rhs.c1.X + lhs.c1.Y * rhs.c1.Y + lhs.c2.Y * rhs.c1.Z), (lhs.c0.Z * rhs.c1.X + lhs.c1.Z * rhs.c1.Y + lhs.c2.Z * rhs.c1.Z)),
                new UInt3((lhs.c0.X * rhs.c2.X + lhs.c1.X * rhs.c2.Y + lhs.c2.X * rhs.c2.Z), (lhs.c0.Y * rhs.c2.X + lhs.c1.Y * rhs.c2.Y + lhs.c2.Y * rhs.c2.Z), (lhs.c0.Z * rhs.c2.X + lhs.c1.Z * rhs.c2.Y + lhs.c2.Z * rhs.c2.Z))
            );
        }
