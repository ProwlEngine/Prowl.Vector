...
public partial struct UInt4x4 : System.IEquatable<UInt4x4>, IFormattable
{
	...
	/// <summary>Returns the product of two UInt4x4 matrices.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UInt4x4 operator *(UInt4x4 lhs, UInt4x4 rhs)
	{
		return new UInt4x4(
			new UInt4((lhs.c0.X * rhs.c0.X + lhs.c1.X * rhs.c0.Y + lhs.c2.X * rhs.c0.Z + lhs.c3.X * rhs.c0.W), (lhs.c0.Y * rhs.c0.X + lhs.c1.Y * rhs.c0.Y + lhs.c2.Y * rhs.c0.Z + lhs.c3.Y * rhs.c0.W), (lhs.c0.Z * rhs.c0.X + lhs.c1.Z * rhs.c0.Y + lhs.c2.Z * rhs.c0.Z + lhs.c3.Z * rhs.c0.W), (lhs.c0.W * rhs.c0.X + lhs.c1.W * rhs.c0.Y + lhs.c2.W * rhs.c0.Z + lhs.c3.W * rhs.c0.W)),
			new UInt4((lhs.c0.X * rhs.c1.X + lhs.c1.X * rhs.c1.Y + lhs.c2.X * rhs.c1.Z + lhs.c3.X * rhs.c1.W), (lhs.c0.Y * rhs.c1.X + lhs.c1.Y * rhs.c1.Y + lhs.c2.Y * rhs.c1.Z + lhs.c3.Y * rhs.c1.W), (lhs.c0.Z * rhs.c1.X + lhs.c1.Z * rhs.c1.Y + lhs.c2.Z * rhs.c1.Z + lhs.c3.Z * rhs.c1.W), (lhs.c0.W * rhs.c1.X + lhs.c1.W * rhs.c1.Y + lhs.c2.W * rhs.c1.Z + lhs.c3.W * rhs.c1.W)),
			new UInt4((lhs.c0.X * rhs.c2.X + lhs.c1.X * rhs.c2.Y + lhs.c2.X * rhs.c2.Z + lhs.c3.X * rhs.c2.W), (lhs.c0.Y * rhs.c2.X + lhs.c1.Y * rhs.c2.Y + lhs.c2.Y * rhs.c2.Z + lhs.c3.Y * rhs.c2.W), (lhs.c0.Z * rhs.c2.X + lhs.c1.Z * rhs.c2.Y + lhs.c2.Z * rhs.c2.Z + lhs.c3.Z * rhs.c2.W), (lhs.c0.W * rhs.c2.X + lhs.c1.W * rhs.c2.Y + lhs.c2.W * rhs.c2.Z + lhs.c3.W * rhs.c2.W)),
			new UInt4((lhs.c0.X * rhs.c3.X + lhs.c1.X * rhs.c3.Y + lhs.c2.X * rhs.c3.Z + lhs.c3.X * rhs.c3.W), (lhs.c0.Y * rhs.c3.X + lhs.c1.Y * rhs.c3.Y + lhs.c2.Y * rhs.c3.Z + lhs.c3.Y * rhs.c3.W), (lhs.c0.Z * rhs.c3.X + lhs.c1.Z * rhs.c3.Y + lhs.c2.Z * rhs.c3.Z + lhs.c3.Z * rhs.c3.W), (lhs.c0.W * rhs.c3.X + lhs.c1.W * rhs.c3.Y + lhs.c2.W * rhs.c3.Z + lhs.c3.W * rhs.c3.W))
		);
	}
