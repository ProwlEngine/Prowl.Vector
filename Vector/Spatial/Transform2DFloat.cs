...
namespace Prowl.Vector.Spatial
{
    ...
    /// | 0 0 1 |
    /// </summary>
    public struct Transform2DFloat : IEquatable<Transform2DFloat>, IFormattable
    {
        public float A, B, C, D, E, F;

        /// <summary>A transform with default values, representing no transformation.</summary>
        public static readonly Transform2DFloat Identity = new Transform2DFloat(1f, 0f, 0f, 1f, 0f, 0f);

        /// <summary>Initializes a new transform with the specified coefficients.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Transform2DFloat(float a, float b, float c, float d, float e, float f)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Transform2DFloat Inverse()
        {
        ...
        public static Transform2DFloat Lerp(Transform2DFloat start, Transform2DFloat end, float amount)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateTranslation(Float2 translation) => new Transform2DFloat(1f, 0f, 0f, 1f, translation.X, translation.Y);

        /// <summary>Creates a translation transform.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateTranslation(float tx, float ty) => new Transform2DFloat(1f, 0f, 0f, 1f, tx, ty);

        /// <summary>Creates a rotation transform with the angle specified in degrees.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateRotation(float angleInDegrees) => CreateRotationRadians(angleInDegrees * (float)Maths.Deg2Rad);

        /// <summary>Creates a rotation transform with the angle specified in radians.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateRotationRadians(float angleInRadians)
        {
            var cs = Maths.Cos(angleInRadians);
            var sn = Maths.Sin(angleInRadians);
            return new Transform2DFloat(cs, sn, -sn, cs, 0f, 0f);
        }
        
        /// <summary>Creates a uniform scale transform.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateScale(float s) => new Transform2DFloat(s, 0f, 0f, s, 0f, 0f);
        
        /// <summary>Creates a non-uniform scale transform.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateScale(float sx, float sy) => new Transform2DFloat(sx, 0f, 0f, sy, 0f, 0f);

        /// <summary>Creates a skew transform along the X-axis.</summary>
        /// <param name="angleInDegrees">The angle in degrees to skew by.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateSkewX(float angleInDegrees)
        {
            return new Transform2DFloat(1f, 0f, Maths.Tan(angleInDegrees * (float)Maths.Deg2Rad), 1f, 0f, 0f);
        }

        /// <summary>Creates a skew transform along the Y-axis.</summary>
        /// <param name="angleInDegrees">The angle in degrees to skew by.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateSkewY(float angleInDegrees)
        {
            return new Transform2DFloat(1f, Maths.Tan(angleInDegrees * (float)Maths.Deg2Rad), 0f, 1f, 0f, 0f);
        }

        /// <summary>Creates a skew transform along the X-axis around a pivot point.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateSkewX(float angleInDegrees, Float2 origin)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat CreateSkewY(float angleInDegrees, Float2 origin)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform2DFloat operator *(Transform2DFloat left, Transform2DFloat right)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Float2 operator *(Transform2DFloat transform, Float2 point) => transform.TransformPoint(point);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(Transform2DFloat left, Transform2DFloat right) => left.Equals(right);
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(Transform2DFloat other)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object? obj) => obj is Transform2DFloat other && Equals(other);
        ...
        {
            return string.Format(formatProvider, "Transform2DFloat(Position: {0}, Rotation: {1}, Scale: {2})", 
