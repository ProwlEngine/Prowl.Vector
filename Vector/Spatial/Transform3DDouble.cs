...
namespace Prowl.Vector.Spatial
{
    ...
    public struct Transform3DDouble : IEquatable<Transform3DDouble>
    {
        ...
        public static readonly Transform3DDouble Identity = new Transform3DDouble(Double3.Zero, Quaternion.Identity, Double3.One);

        /// <summary>
        /// Initializes a new transform with specified position, rotation, and scale.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Transform3DDouble(Double3 position, Quaternion rotation, Double3 scale)
        {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => (Double3)rotation.ToEulerDegrees(EulerOrder.ZYXr);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
