...
namespace Prowl.Vector.Spatial
{
    ...
    /// </summary>
    public struct Transform3DFloat : IEquatable<Transform3DFloat>
    {
        ...
        public static readonly Transform3DFloat Identity = new(Float3.Zero, QuaternionFloat.Identity, Float3.One);

        /// <summary>
        /// Initializes a new transform with specified position, rotation, and scale.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Transform3DFloat(Float3 position, QuaternionFloat rotation, Float3 scale)
        {
        ...
        public Float4x4 ToInverseMatrix()
        {
            ...
            var invScale = new Float3(1f / scale.X, 1f / scale.Y, 1f / scale.Z);
        ...
        /// </summary>
        public static Transform3DFloat FromMatrix(Float4x4 m)
        {
            Float3 scale = new Float3(
                new Float3(m.c0.X, m.c0.Y, m.c0.Z).Length,
                new Float3(m.c1.X, m.c1.Y, m.c1.Z).Length,
                new Float3(m.c2.X, m.c2.Y, m.c2.Z).Length
            );
            ...
            return new Transform3DFloat(m.c3.XYZ, Maths.FromMatrix(rotMatrix), scale);
        }
        ...
        {
            Rotate(QuaternionFloat.FromEulerDegrees(eulerAngles, EulerOrder.ZYXr), relativeToSelf);
        }

        /// <summary>Applies a rotation of angle (in degrees) around an axis.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Rotate(QuaternionFloat rot, bool relativeToSelf = true)
        {
            if (relativeToSelf)
        ...
        {
            var rot = QuaternionFloat.AxisAngle(axis.Normalized, angleDegrees * (float)Maths.Deg2Rad);
        ...
        {
            rotation = QuaternionFloat.LookRotationSafe(target - position, worldUp);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Transform3DFloat Lerp(Transform3DFloat a, Transform3DFloat b, float t)
        {
            t = Maths.Clamp(t, 0f, 1f);
            return new Transform3DFloat(
                Maths.Lerp(a.position, b.position, t),
                QuaternionFloat.Nlerp(a.rotation, b.rotation, t),
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(Transform3DFloat other)
        {
        ...
        {
            return obj is Transform3DFloat other && Equals(other);
        }
        ...
        {
            return $"Transform3DFloat(Position: {position}, Rotation: {rotation}, Scale: {scale})";
        }

        public static bool operator ==(Transform3DFloat left, Transform3DFloat right) => left.Equals(right);
        public static bool operator !=(Transform3DFloat left, Transform3DFloat right) => !left.Equals(right);
