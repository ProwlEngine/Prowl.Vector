...
namespace Prowl.Vector.Spatial
{
    ...
    public struct Transform3DFloat : IEquatable<Transform3DFloat>
    {
        ...
        public static readonly Transform3DFloat Identity = new Transform3DFloat(Float3.Zero, Quaternion.Identity, Float3.One);

        /// <summary>
        /// Initializes a new transform with specified position, rotation, and scale.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Transform3DFloat(Float3 position, Quaternion rotation, Float3 scale)
        {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => (Float3)rotation.ToEulerDegrees(EulerOrder.ZYXr);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        public void RotateAround(Float3 point, Float3 axis, float angleDegrees)
        {
            ...
            vector = (Float3)(Maths.Mul(rot, (Float3)vector));
