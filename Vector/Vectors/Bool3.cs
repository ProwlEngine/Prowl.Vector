...
public partial struct Bool3 : IEquatable<Bool3>, IFormattable
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator ==(Bool3 lhs, Bool3 rhs) { return lhs.X == rhs.X && lhs.Y == rhs.Y && lhs.Z == rhs.Z; }

	/// <summary>Returns true if any component of the vectors are not equal.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator !=(Bool3 lhs, Bool3 rhs) { return !(lhs == rhs); }
