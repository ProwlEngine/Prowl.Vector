...
public partial struct Byte3 : IEquatable<Byte3>, IFormattable
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Byte3 operator ~(Byte3 v) { return new Byte3((byte)(~v.X), (byte)(~v.Y), (byte)(~v.Z)); }

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Byte3 operator <<(Byte3 v, int amount) { return new Byte3((byte)(v.X << amount), (byte)(v.Y << amount), (byte)(v.Z << amount)); }
	...
	/// <summary>Explicitly converts a Float3 to a Byte3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte3(Float3 v) => new Byte3(v);

	/// <summary>Explicitly converts a Double3 to a Byte3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte3(Double3 v) => new Byte3(v);

	/// <summary>Explicitly converts a Int3 to a Byte3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte3(Int3 v) => new Byte3(v);

	/// <summary>Explicitly converts a UShort3 to a Byte3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte3(UShort3 v) => new Byte3(v);

	/// <summary>Explicitly converts a UInt3 to a Byte3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte3(UInt3 v) => new Byte3(v);

	/// <summary>Explicitly converts a ULong3 to a Byte3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte3(ULong3 v) => new Byte3(v);
