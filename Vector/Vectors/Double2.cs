...
public partial struct Double2 : IEquatable<Double2>, IFormattable
{
	...
	/// <summary>Implicitly converts a Float2 to a Double2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double2(Float2 v) => new Double2(v);

	/// <summary>Implicitly converts a Int2 to a Double2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double2(Int2 v) => new Double2(v);

	/// <summary>Implicitly converts a Byte2 to a Double2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double2(Byte2 v) => new Double2(v);

	/// <summary>Implicitly converts a UShort2 to a Double2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double2(UShort2 v) => new Double2(v);

	/// <summary>Implicitly converts a UInt2 to a Double2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double2(UInt2 v) => new Double2(v);

	/// <summary>Implicitly converts a ULong2 to a Double2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double2(ULong2 v) => new Double2(v);
