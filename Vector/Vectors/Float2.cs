...
public partial struct Float2 : IEquatable<Float2>, IFormattable
{
	...
	/// <summary>Implicitly converts PHANG Float2 to Double2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double2(Float2 value) => new Double2((double)value.X, (double)value.Y);

	/// <summary>Explicitly converts PHANG Float2 to Int2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Int2(Float2 value) => new Int2((int)value.X, (int)value.Y);

	/// <summary>Explicitly converts PHANG Float2 to Byte2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte2(Float2 value) => new Byte2((byte)value.X, (byte)value.Y);

	/// <summary>Explicitly converts PHANG Float2 to UShort2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort2(Float2 value) => new UShort2((ushort)value.X, (ushort)value.Y);

	/// <summary>Explicitly converts PHANG Float2 to UInt2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UInt2(Float2 value) => new UInt2((uint)value.X, (uint)value.Y);

	/// <summary>Explicitly converts PHANG Float2 to ULong2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator ULong2(Float2 value) => new ULong2((ulong)value.X, (ulong)value.Y);
