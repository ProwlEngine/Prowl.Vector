...
public partial struct Float3 : IEquatable<Float3>, IFormattable
{
	...
	/// <summary>Explicitly converts a Double3 to a Float3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Float3(Double3 v) => new Float3(v);

	/// <summary>Implicitly converts a Int3 to a Float3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float3(Int3 v) => new Float3(v);

	/// <summary>Implicitly converts a Byte3 to a Float3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float3(Byte3 v) => new Float3(v);

	/// <summary>Implicitly converts a UShort3 to a Float3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float3(UShort3 v) => new Float3(v);

	/// <summary>Implicitly converts a UInt3 to a Float3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float3(UInt3 v) => new Float3(v);

	/// <summary>Implicitly converts a ULong3 to a Float3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float3(ULong3 v) => new Float3(v);
