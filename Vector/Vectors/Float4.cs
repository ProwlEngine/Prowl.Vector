...
public partial struct Float4 : IEquatable<Float4>, IFormattable
{
	...
	/// <summary>Explicitly converts a Double4 to a Float4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Float4(Double4 v) => new Float4(v);

	/// <summary>Implicitly converts a Int4 to a Float4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float4(Int4 v) => new Float4(v);

	/// <summary>Implicitly converts a Byte4 to a Float4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float4(Byte4 v) => new Float4(v);

	/// <summary>Implicitly converts a UShort4 to a Float4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float4(UShort4 v) => new Float4(v);

	/// <summary>Implicitly converts a UInt4 to a Float4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float4(UInt4 v) => new Float4(v);

	/// <summary>Implicitly converts a ULong4 to a Float4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float4(ULong4 v) => new Float4(v);
