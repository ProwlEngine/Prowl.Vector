...
public partial struct Float4 : IEquatable<Float4>, IFormattable
{
	...
	/// <summary>Implicitly converts PHANG Float4 to Double4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	...
	/// <summary>Explicitly converts PHANG Float4 to UInt4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UInt4(Float4 value) => new UInt4((uint)value.X, (uint)value.Y, (uint)value.Z, (uint)value.W);

	/// <summary>Explicitly converts PHANG Float4 to ULong4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
