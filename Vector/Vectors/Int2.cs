...
public partial struct Int2 : IEquatable<Int2>, IFormattable
{
	...
	/// <summary>Implicitly converts PHANG Int2 to Float2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float2(Int2 value) => new Float2((float)value.X, (float)value.Y);

	/// <summary>Implicitly converts PHANG Int2 to Double2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double2(Int2 value) => new Double2((double)value.X, (double)value.Y);

	/// <summary>Explicitly converts PHANG Int2 to Byte2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte2(Int2 value) => new Byte2((byte)value.X, (byte)value.Y);

	/// <summary>Explicitly converts PHANG Int2 to UShort2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort2(Int2 value) => new UShort2((ushort)value.X, (ushort)value.Y);

	/// <summary>Explicitly converts PHANG Int2 to UInt2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UInt2(Int2 value) => new UInt2((uint)value.X, (uint)value.Y);

	/// <summary>Explicitly converts PHANG Int2 to ULong2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator ULong2(Int2 value) => new ULong2((ulong)value.X, (ulong)value.Y);
