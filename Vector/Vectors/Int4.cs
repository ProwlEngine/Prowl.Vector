...
public partial struct Int4 : IEquatable<Int4>, IFormattable
{
	...
	/// <summary>Implicitly converts PHANG Int4 to Float4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float4(Int4 value) => new Float4((float)value.X, (float)value.Y, (float)value.Z, (float)value.W);

	/// <summary>Implicitly converts PHANG Int4 to Double4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double4(Int4 value) => new Double4((double)value.X, (double)value.Y, (double)value.Z, (double)value.W);

	/// <summary>Explicitly converts PHANG Int4 to Byte4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte4(Int4 value) => new Byte4((byte)value.X, (byte)value.Y, (byte)value.Z, (byte)value.W);

	/// <summary>Explicitly converts PHANG Int4 to UShort4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort4(Int4 value) => new UShort4((ushort)value.X, (ushort)value.Y, (ushort)value.Z, (ushort)value.W);

	/// <summary>Explicitly converts PHANG Int4 to UInt4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UInt4(Int4 value) => new UInt4((uint)value.X, (uint)value.Y, (uint)value.Z, (uint)value.W);

	/// <summary>Explicitly converts PHANG Int4 to ULong4.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator ULong4(Int4 value) => new ULong4((ulong)value.X, (ulong)value.Y, (ulong)value.Z, (ulong)value.W);
