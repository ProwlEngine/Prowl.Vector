...
public partial struct UInt2 : IEquatable<UInt2>, IFormattable
{
	...
	/// <summary>Implicitly converts PHANG UInt2 to Float2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float2(UInt2 value) => new Float2((float)value.X, (float)value.Y);

	/// <summary>Implicitly converts PHANG UInt2 to Double2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double2(UInt2 value) => new Double2((double)value.X, (double)value.Y);

	/// <summary>Implicitly converts PHANG UInt2 to Int2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Int2(UInt2 value) => new Int2((int)value.X, (int)value.Y);

	/// <summary>Explicitly converts PHANG UInt2 to Byte2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte2(UInt2 value) => new Byte2((byte)value.X, (byte)value.Y);

	/// <summary>Explicitly converts PHANG UInt2 to UShort2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort2(UInt2 value) => new UShort2((ushort)value.X, (ushort)value.Y);

	/// <summary>Implicitly converts PHANG UInt2 to ULong2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator ULong2(UInt2 value) => new ULong2((ulong)value.X, (ulong)value.Y);
