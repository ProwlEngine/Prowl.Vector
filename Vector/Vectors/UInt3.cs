...
public partial struct UInt3 : IEquatable<UInt3>, IFormattable
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UInt3 operator ~(UInt3 v) { return new UInt3(~v.X, ~v.Y, ~v.Z); }

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UInt3 operator <<(UInt3 v, int amount) { return new UInt3(v.X << amount, v.Y << amount, v.Z << amount); }
