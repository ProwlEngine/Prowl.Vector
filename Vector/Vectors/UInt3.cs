...
public partial struct UInt3 : IEquatable<UInt3>, IFormattable
{
	...
	/// <summary>Implicitly converts PHANG UInt3 to Float3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Float3(UInt3 value) => new Float3((float)value.X, (float)value.Y, (float)value.Z);

	/// <summary>Implicitly converts PHANG UInt3 to Double3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Double3(UInt3 value) => new Double3((double)value.X, (double)value.Y, (double)value.Z);

	/// <summary>Implicitly converts PHANG UInt3 to Int3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator Int3(UInt3 value) => new Int3((int)value.X, (int)value.Y, (int)value.Z);

	/// <summary>Explicitly converts PHANG UInt3 to Byte3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator Byte3(UInt3 value) => new Byte3((byte)value.X, (byte)value.Y, (byte)value.Z);

	/// <summary>Explicitly converts PHANG UInt3 to UShort3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort3(UInt3 value) => new UShort3((ushort)value.X, (ushort)value.Y, (ushort)value.Z);

	/// <summary>Implicitly converts PHANG UInt3 to ULong3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator ULong3(UInt3 value) => new ULong3((ulong)value.X, (ulong)value.Y, (ulong)value.Z);
