...
public partial struct ULong3 : IEquatable<ULong3>, IFormattable
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static ULong3 operator ~(ULong3 v) { return new ULong3(~v.X, ~v.Y, ~v.Z); }

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static ULong3 operator <<(ULong3 v, int amount) { return new ULong3(v.X << amount, v.Y << amount, v.Z << amount); }
	...
	/// <summary>Explicitly converts a Float3 to a ULong3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator ULong3(Float3 v) => new ULong3(v);

	/// <summary>Explicitly converts a Double3 to a ULong3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator ULong3(Double3 v) => new ULong3(v);

	/// <summary>Explicitly converts a Int3 to a ULong3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator ULong3(Int3 v) => new ULong3(v);

	/// <summary>Implicitly converts a Byte3 to a ULong3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator ULong3(Byte3 v) => new ULong3(v);

	/// <summary>Implicitly converts a UShort3 to a ULong3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator ULong3(UShort3 v) => new ULong3(v);

	/// <summary>Implicitly converts a UInt3 to a ULong3.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator ULong3(UInt3 v) => new ULong3(v);
