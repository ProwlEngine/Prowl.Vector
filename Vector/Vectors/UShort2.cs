...
public partial struct UShort2 : IEquatable<UShort2>, IFormattable
{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UShort2 operator ~(UShort2 v) { return new UShort2((ushort)(~v.X), (ushort)(~v.Y)); }

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static UShort2 operator <<(UShort2 v, int amount) { return new UShort2((ushort)(v.X << amount), (ushort)(v.Y << amount)); }
	...
	/// <summary>Explicitly converts a Float2 to a UShort2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort2(Float2 v) => new UShort2(v);

	/// <summary>Explicitly converts a Double2 to a UShort2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort2(Double2 v) => new UShort2(v);

	/// <summary>Explicitly converts a Int2 to a UShort2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort2(Int2 v) => new UShort2(v);

	/// <summary>Implicitly converts a Byte2 to a UShort2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static implicit operator UShort2(Byte2 v) => new UShort2(v);

	/// <summary>Explicitly converts a UInt2 to a UShort2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort2(UInt2 v) => new UShort2(v);

	/// <summary>Explicitly converts a ULong2 to a UShort2.</summary>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static explicit operator UShort2(ULong2 v) => new UShort2(v);
